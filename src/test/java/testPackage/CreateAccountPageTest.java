...
public class CreateAccountPageTest extends BaseClass {
	...
	@Test(priority = 6, description = "Registration Page | Check that warning message is displayed when user inputs a weak password")
	public void validateValidRegistration() {
		...
		registrationPage.clickRegisterBtn();
		Assert.assertTrue(registrationPage.//addEelmentOnPage());
	}
